...
const app_face_config_t APP_FACE_DEFAULT_CONFIG = {
    ...
    .motion = {
        ...
        .gaze_move_out_ms = 360,
        .gaze_hold_min_ms = 520,
        .gaze_hold_max_ms = 820,
        .gaze_return_ms = 540,
        .gaze_gap_min_ms = 3400,
        .gaze_gap_max_ms = 7200,
        .gaze_max_total_x = 0.30f,
        .gaze_max_total_y = 0.11f,
        .drift_max_x = 0.14f,
        .drift_max_y = 0.055f,
        .tilt_vector_limit = 1.0f,
        .drift_speed_base = 0.35f,
        .drift_speed_energy = 0.16f,
        .blink_close = 0.36f,
        .blink_hold = 0.18f,
        .blink_open = 0.62f,
        .blink_minimum_open = 0.018f,
        .blink_randomness = 0.70f,
        .nod_frequency_base = 2.5f,
        .nod_frequency_energy = 1.4f,
        .click_pulse_ms = 420,
    },
    .energy = {
        .gaze_ease_low = 0.72f,
        ...
        .blink_duration_low_ms = 220.0f,
        .blink_duration_high_ms = 82.0f,
    },
};
